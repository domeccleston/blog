...
It's not obvious why our societies should need to constantly be growing. Since we're already wealthy, can't we just be happy with what we have? Indeed, this is actually a common line of argument from proponents of degrowth, usually along environmental lines: maybe we should aim to [reduce economic growth along with consumption](https://www.theguardian.com/commentisfree/2020/apr/24/economic-crisis-degrowth-green-new-deal), or [pull a Bhutan and track Gross National Happiness instead](https://ophi.org.uk/policy/gross-national-happiness-index/#:~:text=The%20phrase%20'gross%20national%20happiness,approach%20towards%20notions%20of%20progress).
...
For example, it might be the case that the spoils of economic growth had overwhelmingly accreted to the wealthiest in society. That would mean that standards of living improved for a small subset of society, but that the poor remained poor.
